...
INSERT INTO `migrations` VALUES (1,'0001_01_01_000000_create_users_table',1),(2,'0001_01_01_000001_create_cache_table',1),(3,'0001_01_01_000002_create_jobs_table',1),(4,'2026_06_06_141209_add_link_teams_to_aulas_table',2),(5,'2026_06_11_074531_create_reagendamentos_table',3),(6,'2026_06_13_152924_create_presenca_table',4);
...
CREATE TABLE `presenca` (
  ...
  `status_presenca` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `reagendamentos` VALUES (8,1,4,1,'2026-12-20 00:31:00',NULL,'2026-12-25 14:20:00','Preciso reagenda minha aula',NULL,'confirmado',1,0,'2026-06-11 20:17:19','2026-06-11 20:18:17',NULL),(10,3,4,1,'2026-08-22 18:30:00',NULL,'2026-08-18 14:30:00','Motivo particular',NULL,'confirmado',1,0,'2026-06-12 20:11:31','2026-06-12 20:12:53',NULL);
...
INSERT INTO `sessions` VALUES ('EJQdh2E823iNeonlSkmByuBwNnK8BITmUC2VdHGS',1,'172.18.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36 Edg/149.0.0.0','',1781455259),('tyM5hfuTeAn8faHrZCVAVOGawWyBzTr7O1RB4BvW',NULL,'172.18.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36 Edg/149.0.0.0','eyJfdG9rZW4iOiJTaU92bVRhR3o5YThwaVlHanZZRVg3ZWltVVp4Yk9pTFJ6T0NtMGFyIiwiX2ZsYXNoIjp7Im9sZCI6W10sIm5ldyI6W119LCJfcHJldmlvdXMiOnsidXJsIjoiaHR0cDpcL1wvbG9jYWxob3N0OjgwODFcL2FsdW5vXC9sb2dpbiIsInJvdXRlIjoiYWx1bm8ubG9naW4ifX0=',1781461387);
...
INSERT INTO `tbl_agenda` VALUES (2,3,1,'Italiano','Textos narrativos','2026-08-18','14:30:00','15:30:00','reagendado',NULL,NULL,'2026-06-12 20:12:53','2026-06-12 20:12:53'),(3,4,1,'Ingles','Aulas pratica verbos etc','2026-09-18','12:55:00','13:50:00','confirmado',NULL,'https://meet.google.com/jds-afuj-fhw','2026-06-13 16:37:37','2026-06-13 16:37:37');
...
INSERT INTO `tbl_alunos` VALUES (1,'Caio Ferreira','caioferreira@gmail.com','$2y$12$fr8P4A/2SugUi1VIdBJsCOWL8DKRLetpyRZDTGg6zC2RuIxWwAooq','(11)94002-4582','Inglês','2010-05-17','Avançado','caio-ferreira.png','EM CURSO','2026-03-17 09:05:05','2026-06-14 16:48:45'),(2,'Paulo Vicente','paulovicente@gmail.com','4132','(11)99972-7631','Italiano','2003-04-23','Intermediário','paulo-vicente.png','EM CURSO','2026-03-17 09:11:06','2026-06-12 23:18:04'),(3,'Lorena Marques','lorenamarques@gmail.com','$2y$12$ZWiQfyAiKcT3HnD4ALxZVePZVjA.HWjDKa1BBrgHH3SqlHiG44zru','(11)99345-0123','Inglês','2016-10-07','Intermediário','lorena-marques.png','CONCLUIDO','2026-03-17 09:28:46','2026-06-14 17:11:45'),(4,'Biatriz silva','bia.s@gmail.com','$2y$12$Cjc5kN3Aj8D9qwVsArIQle4Wd87Mx0EwYtaCnLqYxA5HD.66mxPrG','1196699988','Inglês','2019-01-02','Iniciante','biatriz-silva.png','EM CURSO','2026-06-01 22:29:53','2026-06-13 19:45:21'),(5,'Cesar Marcelino','cesar.m@gmail.com','$2y$12$4ZB6mZGFDItTt/Dn3ttO1eN/XcZa8k0fbwDNe4.i10boLSSa0BWGK','117777-7785','Italiano','1965-02-11','Iniciante','cesar-marcelino.png','CONCLUIDO','2026-06-07 14:53:36','2026-06-07 20:14:49');
...
CREATE TABLE `tbl_materiais` (
  ...
  `curso_materiais` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `tbl_materiais` VALUES (1,1,'Apostila Italiano','Escrita fala','traducaidiomas/materiais/1781304117_1000 frases úteis do dia a dia em italiano.pdf','Italiano','Básico','2026-06-12 19:41:14','2026-06-12 19:42:36',3),(2,1,'Apostila InglÃªs IntermediÃ¡rio','Material de apoio','apostila_ingles.pdf','InglÃªs','IntermediÃ¡rio','2026-06-14 17:37:31','2026-06-14 17:37:31',2);
...
CREATE TABLE `tbl_matricula` (
  ...
  `status_matricula` enum('ATIVO','CONGELADO','CANCELADO') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'ATIVO',
...
INSERT INTO `tbl_matricula` VALUES (1,4,2,3,'2024-10-17 00:00:00','ATIVO'),(2,1,2,1,'2020-10-17 00:00:00','ATIVO'),(3,2,3,2,'2020-10-17 00:00:00','ATIVO'),(5,5,3,1,'1980-10-17 00:00:00','ATIVO'),(6,3,3,1,'2026-10-18 00:00:00','CONGELADO');
...
-- Dump completed on 2026-06-14 15:24:24

ALTER TABLE `traducaidiomas`.`aula_links` 
RENAME TO  `traducaidiomas`.`tbl_aula_links` ;

ALTER TABLE `traducaidiomas`.`aula_links` 
CHANGE COLUMN `id` `id_aula_links` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE COLUMN `created_at` `criado_em_aula_links` TIMESTAMP NOT NULL ,
CHANGE COLUMN `updated_at` `atualizado_em_aula_links` TIMESTAMP NOT NULL ,
CHANGE COLUMN `aluno_id` `id_aluno` BIGINT UNSIGNED NOT NULL ,
CHANGE COLUMN `turma_id` `id_turma` BIGINT UNSIGNED NOT NULL ,
CHANGE COLUMN `data_hora` `data_hora_aula_links` DATETIME NOT NULL ,
CHANGE COLUMN `link` `link_aula_links` VARCHAR(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL ,
CHANGE COLUMN `titulo` `titulo_aula_links` VARCHAR(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL ;

ALTER TABLE `traducaidiomas`.`reagendamentos` 
CHANGE COLUMN `id` `id_reagendamento` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE COLUMN `aluno_id` `id_aluno` BIGINT UNSIGNED NOT NULL ,
CHANGE COLUMN `aula_id` `id_aulas` BIGINT UNSIGNED NOT NULL ,
CHANGE COLUMN `professor_id` `id_professor` BIGINT UNSIGNED NOT NULL ,
CHANGE COLUMN `data_original` `data_original_reagendamento` DATETIME NULL DEFAULT NULL ,
CHANGE COLUMN `data_sugerida` `data_sugerida_reagendamento` DATETIME NULL DEFAULT NULL ,
CHANGE COLUMN `data_nova` `data_nova_reagendamento` DATETIME NULL DEFAULT NULL ,
CHANGE COLUMN `motivo` `motivo_reagendamento` TEXT CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL ,
CHANGE COLUMN `resposta_professor` `resposta_professor_reagendamento` TEXT CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL ,
CHANGE COLUMN `status` `status_reagendamento` VARCHAR(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL DEFAULT 'pendente' ,
CHANGE COLUMN `notificado_professor` `notificado_professor_reagendamento` TINYINT(1) NOT NULL DEFAULT '0' ,
CHANGE COLUMN `notificado_aluno` `notificado_aluno_reagedamento` TINYINT(1) NOT NULL DEFAULT '0' ,
CHANGE COLUMN `created_at` `criado_em_reagendamento` TIMESTAMP NULL DEFAULT NULL ,
CHANGE COLUMN `updated_at` `atualizado_em_reagendamento` TIMESTAMP NULL DEFAULT NULL ,
CHANGE COLUMN `confirmado_em` `confirmado_em_reagendamento` DATETIME NULL DEFAULT NULL , RENAME TO  `traducaidiomas`.`tbl_reagendamentos` ;
