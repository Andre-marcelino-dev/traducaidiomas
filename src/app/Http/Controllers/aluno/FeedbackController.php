...
class FeedbackController extends Controller
{
    public function store(Request $request)
    {
        ...
        if (!Schema::hasTable('tbl_feedbacks')) {
            return back()->with('warning', 'O feedback ainda n?o est? dispon?vel neste ambiente.');
        }
        ...
        return back()->with('success', 'Feedback enviado com sucesso! Obrigado pela sua avalia??o.');
    }
}
