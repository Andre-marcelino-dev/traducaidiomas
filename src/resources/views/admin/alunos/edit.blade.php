...
<style>
    ...
    .foto-preview-box #previewImagemAluno {
        display: none;
    }
...
<div class="container-fluid aluno-page">
    ...
    <div class="aluno-header">
        <div class="aluno-title-box">
            <h1>Editar Aluno</h1>
            <p>Atualize os dados cadastrais, acesso e informações do aluno.</p>
        </div>
    ...
    <div class="card aluno-card">
        <div class="aluno-card-header">
            ...
            <div>
                ...
                <span>Editando: {{ $aluno->nome_aluno }}</span>
            </div>
        </div>

        <div class="aluno-card-body">
            <form action="{{ route('admin.alunos.update', $aluno->id_aluno) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input 
                            ...
                            value="{{ old('email_aluno', $aluno->email_aluno) }}"
                            required
                        >
                        @error('email_aluno')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input 
                            ...
                            value="{{ old('telefone_aluno', $aluno->telefone_aluno) }}"
                    ...
                    <div class="col-md-4">
                        ...
                        <input 
                            ...
                            value="{{ old('data_nasc_aluno', $aluno->data_nasc_aluno) }}"
                        >
                    ...
                    <div class="col-md-4">
                        ...
                        <input 
                            ...
                            value="{{ old('curso_aluno', $aluno->curso_aluno) }}"
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label">
                            Nova Senha
                            <span class="text-muted" style="font-weight:500;">(opcional)</span>
                        </label>
                        <input 
                            type="password" 
                            name="senha_aluno" 
                        ...
                        @error('senha_aluno')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="input-hint">Preencha somente se quiser trocar a senha do aluno.</div>
                    </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="nivel_aluno" class="form-select @error('nivel_aluno') is-invalid @enderror">
                            <option value="Iniciante" {{ old('nivel_aluno', $aluno->nivel_aluno) == 'Iniciante' ? 'selected' : '' }}>
                                Iniciante
                            </option>

                            <option value="Intermediário" {{ old('nivel_aluno', $aluno->nivel_aluno) == 'Intermediário' ? 'selected' : '' }}>
                                Intermediário
                            </option>

                            <option value="Avançado" {{ old('nivel_aluno', $aluno->nivel_aluno) == 'Avançado' ? 'selected' : '' }}>
                                Avançado
                            </option>
                        </select>
                        @error('nivel_aluno')
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status_aluno" class="form-select @error('status_aluno') is-invalid @enderror">
                            <option value="EM CURSO" {{ old('status_aluno', $aluno->status_aluno) == 'EM CURSO' ? 'selected' : '' }}>
                                EM CURSO
                            </option>

                            <option value="CONCLUIDO" {{ old('status_aluno', $aluno->status_aluno) == 'CONCLUIDO' ? 'selected' : '' }}>
                                CONCLUÍDO
                            </option>

                            <option value="INATIVO" {{ old('status_aluno', $aluno->status_aluno) == 'INATIVO' ? 'selected' : '' }}>
                                INATIVO
                            </option>
                        </select>
                        @error('status_aluno')
                ...
                <div class="row g-3 align-items-start">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-hint">Escolha uma nova foto somente se quiser substituir a atual.</div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="foto-preview-box">
                            <img id="previewImagemAluno" src="" alt="Pré-visualização da nova foto">
