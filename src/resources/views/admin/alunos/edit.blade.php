            ...
            <form action="{{ route('admin.alunos.update', $aluno->id_aluno) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="nome_aluno" class="form-control" value="{{ $aluno->nome_aluno }}" required>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" name="data_nasc_aluno" class="form-control" value="{{ $aluno->data_nasc_aluno }}">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Nível</label>
                        <select name="nivel_aluno" class="form-select">
                            <option value="Iniciante" {{ $aluno->nivel_aluno == 'Iniciante' ? 'selected' : '' }}>Iniciante</option>
                            <option value="Intermediário" {{ $aluno->nivel_aluno == 'Intermediário' ? 'selected' : '' }}>Intermediário</option>
                            <option value="Avançado" {{ $aluno->nivel_aluno == 'Avançado' ? 'selected' : '' }}>Avançado</option>
                        </select>
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="status_aluno" class="form-select">
                            ...
                            <option value="CONCLUÍDO" {{ $aluno->status_aluno == 'CONCLUÍDO' ? 'selected' : '' }}>CONCLUÍDO</option>
