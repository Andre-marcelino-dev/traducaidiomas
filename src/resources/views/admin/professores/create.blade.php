...
<style>
    ...
    .prof-preview-box:hover {
        border-color: #163d8f;
        background: #f8fbff;
    }

    .prof-preview-box img {
        max-width: 100%;
        max-height: 145px;
        display: none;
        border-radius: 14px;
    ...
    <div class="card prof-form-card">
        <div class="prof-form-card-header">
            ...
            <div>
                ...
                <span>Informações pessoais, acesso, experiência e foto</span>
            </div>
        </div>
        ...
        <div class="prof-form-body">
            <form action="{{ route('admin.professores.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        >
                            ...
                            <option value="Básico" {{ old('nivel_professor') == 'Básico' ? 'selected' : '' }}>Básico</option>
                            <option value="Intermediário" {{ old('nivel_professor') == 'Intermediário' ? 'selected' : '' }}>Intermediário</option>
                            <option value="Avançado" {{ old('nivel_professor') == 'Avançado' ? 'selected' : '' }}>Avançado</option>
                            <option value="Fluente" {{ old('nivel_professor') == 'Fluente' ? 'selected' : '' }}>Fluente</option>
                        </select>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <label for="senha_professor" class="form-label">
                        ...
                        <div class="prof-hint">
                            Essa senha será usada no acesso do professor.
                        </div>
                    </div>

                    <div class="col-md-6">
                        <label for="senha_professor_confirmation" class="form-label">
                ...
                <div class="row g-3 align-items-start">
                    <div class="col-md-6">
                        <label for="foto_professor" class="form-label">Foto</label>
