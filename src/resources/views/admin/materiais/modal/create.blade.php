                    ...
                    <div class="card material-form-card">
                        <div class="material-form-header">
                            ...
                            <div>
                                ...
                                <span>Adicione apostilas, arquivos e conteúdos para os alunos.</span>
                            </div>
                        </div>
                            ...
                            <form action="{{ route('admin.materiais.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        >{{ old('descricao_materiais') }}</textarea>
                                ...
                                <div class="material-file-box">
                                    <div class="material-file-info">
                                        ...
                                        <div>
                                            <div class="material-file-title">Enviar arquivo do material</div>
                                            <div class="material-file-sub">
                                                PDF, Word, PowerPoint, Excel ou ZIP. Máximo 20 MB.
                                            </div>
                                        </div>
                                    </div>
...
function mostrarArquivoSelecionado(event) {
    ...
    if (input.files && input.files[0]) {
        ...
        box.textContent = 'Arquivo selecionado: ' + arquivo.name + ' (' + tamanhoMb + ' MB)';
    } else {
