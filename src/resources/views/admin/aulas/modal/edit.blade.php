...
<div class="container-fluid aula-page">
    ...
    @php
        $alunosSelecionados = old('alunos', collect(data_get($aula, 'alunos', []))->pluck('id_aluno')->all());
    @endphp
    ...
    <div class="aula-page-header">
        <div>
            ...
            <h1>Editar Aula</h1>
            <p>Atualize os dados da aula, altere data, horário, professor, curso e os alunos participantes.</p>
        </div>
    ...
    <div class="aula-form-card">
        <div class="aula-form-card-header">
            <div>
                <h5>Atualização da Aula</h5>
                <p>Edite as informações abaixo para manter o agendamento atualizado.</p>
            </div>
            ...
            <form action="{{ route('admin.aulas.update', $aula->id_aulas) }}" method="POST">
                ...
                <div class="row g-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="status_aulas" class="form-select" required>
                                        <option value="ATIVO" {{ old('status_aulas', $aula->status_aulas) == 'ATIVO' ? 'selected' : '' }}>ATIVO</option>
                                        <option value="INATIVO" {{ old('status_aulas', $aula->status_aulas) == 'INATIVO' ? 'selected' : '' }}>INATIVO</option>
                                        <option value="CANCELADO" {{ old('status_aulas', $aula->status_aulas) == 'CANCELADO' ? 'selected' : '' }}>CANCELADO</option>
                                        <option value="FINALIZADA" {{ old('status_aulas', $aula->status_aulas) == 'FINALIZADA' ? 'selected' : '' }}>FINALIZADA</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-5">
                        <div class="aula-section">
                            ...
                            <div class="aula-dt-picker" id="agenda_aula_edit">
                            ...
                            <input type="hidden" name="data_aulas" id="data_aulas_edit" value="{{ old('data_aulas', $aula->data_aulas) }}">
                            <input type="hidden" name="hora_aulas" id="hora_aulas_edit" value="{{ old('hora_aulas', $aula->hora_aulas) }}">
                            ...
                            <small class="text-muted d-block mt-2">
                                Atualize a data e o horário usando o calendário.
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="aula-section mt-4">
                    <div class="aula-students-toolbar">
                        ...
                        <span class="aula-students-counter" id="contadorAlunosEdit">
                            0 selecionados
                        </span>
                    </div>
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-4">
                            <button type="button" class="btn btn-outline-primary w-100 h-100" id="selecionarVisiveisEdit">
                    ...
                    <div class="aula-students-box">
                        <div class="row g-2" id="lista-alunos-edit">
                                ...
                                <div class="col-md-6 col-xl-4 aluno-item"
                                    ...
                                    <label class="aula-student-card d-flex align-items-start gap-2">
                                        <input type="checkbox"
                                            ...
                                            {{ in_array($aluno->id_aluno, $alunosSelecionados) ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const alunos = document.querySelectorAll('#lista-alunos-edit .aluno-item');
    const selecionarVisiveis = document.getElementById('selecionarVisiveisEdit');
    const buscarAluno = document.getElementById('buscarAlunoEdit');
    const contadorAlunos = document.getElementById('contadorAlunosEdit');
    ...
    function atualizarContador() {
        const selecionados = document.querySelectorAll('#lista-alunos-edit input[type="checkbox"]:checked').length;
    ...
    selecionarVisiveis?.addEventListener('click', function() {
        document.querySelectorAll('#lista-alunos-edit .aluno-item').forEach(function(item) {
    ...
    document.querySelectorAll('#lista-alunos-edit input[type="checkbox"]').forEach(function(checkbox) {
...
<script>
document.addEventListener('DOMContentLoaded', function() {
    const dataInput = document.getElementById('data_aulas_edit');
    const horaInput = document.getElementById('hora_aulas_edit');
    const picker = document.getElementById('agenda_aula_edit');
    ...
    form?.addEventListener('submit', function(event) {
        if (!dataInput.value || !horaInput.value) {
            ...
            result.textContent = 'Selecione a data e o horário antes de atualizar.';
            result.classList.remove('is-empty');
