...
<div class="app-content">
    <div class="container-fluid">
        ...
        {{-- Alertas de sucesso/erro do reagendamento --}}
        @if(session('success'))
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-2">
                                    <a href="https://teams.microsoft.com/" target="_blank" class="btn btn-outline-primary w-100 fw-bold d-flex align-items-center justify-content-center gap-2">
                                        <i class="fab fa-windows"></i> Microsoft Teams
                                    </a>
                                </div>
                                <div class="col-sm-6 mb-2">
                                    <a href="https://meet.google.com/" target="_blank" class="btn btn-outline-success w-100 fw-bold d-flex align-items-center justify-content-center gap-2">
    ...
    {{-- ══════════════════════════════════════════
         MODAL DE REAGENDAMENTO — conectado ao controller
    ══════════════════════════════════════════ --}}
    <div class="modal fade" id="modalReagendamento" tabindex="-1" aria-labelledby="modalReagendamentoLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius:16px; border:none; box-shadow:0 20px 60px rgba(0,0,0,.15);">
                ...
                {{-- Formulário conectado à rota correta --}}
                        ...
                        <div class="mb-3">
                            ...
                            <select name="aula_id" id="aula_id"
                                ...
                                <option value="{{ $aula->id_aulas }}" {{ old('aula_id') == $aula->id_aulas ? 'selected' : '' }}>
                                    {{ $aula->titulo_aulas }} — {{ $aula->data_aulas ?? 'Sem data' }} {{ $aula->hora_aulas ?? '' }}
                                </option>
                                @endforeach
                                @endisset
                            </select>
